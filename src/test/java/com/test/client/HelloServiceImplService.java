 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://impl.service.thg.com/", wsdlLocation = "http://localhost:8080/service/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.thg.com/", "HelloServiceImplService");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://impl.service.thg.com/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.thg.com/", "HelloServiceImplPort"), HelloService.class, features);
    }
